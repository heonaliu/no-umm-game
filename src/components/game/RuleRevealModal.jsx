        ...
        <>
          ...
          >
            <div className="pointer-events-auto w-full max-w-sm rounded-3xl bg-white border-2 border-amber-300 shadow-2xl shadow-amber-100 p-7 text-center">
              <button onClick={onClose} className="absolute top-4 right-4 text-indigo-300 hover:text-indigo-500">
                <X size={18} />
              </button>
              ...
              <div className="rounded-2xl bg-amber-50 border border-amber-200 p-4 mb-4">
                <h3 className="font-display text-xl text-indigo-900 mb-1">{rule.title}</h3>
                <p className="text-indigo-600/70 text-sm">{rule.description}</p>
              </div>
